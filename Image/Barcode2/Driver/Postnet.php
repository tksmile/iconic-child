...
require_once dirname( __FILE__, 4 ). '/Image/Barcode2/Driver.php';
require_once dirname( __FILE__, 4 ). '/Image/Barcode2/Common.php';
require_once dirname( __FILE__, 4 ). '/Image/Barcode2/DualHeight.php';
require_once dirname( __FILE__, 4 ). '/Image/Barcode2/Exception.php';

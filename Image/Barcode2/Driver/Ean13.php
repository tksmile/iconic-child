...
require_once get_stylesheet_directory(). '/Image/Barcode2/Driver.php';
require_once get_stylesheet_directory(). '/Image/Barcode2/Common.php';
require_once get_stylesheet_directory(). '/Image/Barcode2/Exception.php';

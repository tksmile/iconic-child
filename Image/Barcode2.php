...
require_once STYLESHEETPATH. '/Image/Barcode2/Writer.php';
require_once STYLESHEETPATH. '/Image/Barcode2/Driver.php';
require_once STYLESHEETPATH. '/Image/Barcode2/Exception.php';
...
class Image_Barcode2
{
    ...
    public static function draw($text,
        ...
        if (!include_once get_stylesheet_directory(). '/Image/Barcode2/Driver/' . ucfirst($type) . '.php') {
